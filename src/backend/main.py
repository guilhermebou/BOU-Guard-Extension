...
def gpt(input_text):
    prompt = [
    {'role': 'user', 'content': 'Identifique e enumere exclusivamente as expressões (frases ou palavras dentro do contexto) presentes nos dados que estão associadas a homofobia(leve o contexto da frase na tematica de homofobia).'},
    {'role': 'user', 'content': 'Identifique e enumere exclusivamente as expressões (frases ou palavras dentro do contexto) presentes nos dados que estão associadas ao racismo (leve o contexto da frase na tematica do racismo).'},
    {'role': 'user', 'content': 'Identifique e enumere exclusivamente as expressões (frases ou palavras dentro do contexto) presentes nos dados que estão associadas ao machismo(leve o contexto da frase na tematica do machismo).'},
...
def analyze():
    try:
        ...
        # condicao se a URL ja foi analisada e se nao forcar a nova analise
